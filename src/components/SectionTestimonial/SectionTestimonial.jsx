  ...
  return (
    <section className="section-testimonials">
      <div className="testimonials-container">
        <span className="subheading">Kiểm định chất lượng</span>
        <h2 className="heading-secondary">Ngon không cưỡng nổi</h2>
